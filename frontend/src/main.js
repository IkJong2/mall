...
pluralCaseList.push( {plural: "selectProducts", pascal: "SelectProduct"} )
pluralCaseList.push( {plural: "checkReservations", pascal: "CheckReservation"} )
pluralCaseList.push( {plural: "deliveryManagements", pascal: "DeliveryManagement"} )

pluralCaseList.push( {plural: "inventoryManagements", pascal: "InventoryManagement"} )
